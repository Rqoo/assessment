'use strict';
const userNameInput = document.getElementById('user-name'); //入力エリアの
const assessmentButton = document.getElementById('assessment');//診断ボタン
const resultDivided = document.getElementById('result-area');//診断結果表示エリア
...
//診断結果表示エリアの作成
const header = document.createElement('h3');//　h３タグを作る
header.innerTxet = '診断結果';//h3タグにテキストを設定
resultaDivided.appendChild(header);//h3タグを診断結果表示エリアに追加
